...
class ReserveWidget extends StatefulWidget {
  ...
  ReserveWidget({Key key, this.bidID}) : super(key: key);

  @override
  _ReserveWidgetState createState() => _ReserveWidgetState();
}

class _ReserveWidgetState extends State<ReserveWidget> with ScreenUtil {
  @override
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                    '${common_utils.DateUtil.formatDate(DateTime.now(), format: 'yyyy年MM月')}, 拍牌预约',
                    style: TextStyle(
                        fontSize: setSp(18), color: Color(0xff333333))),
              ),
              Padding(
                    ...
                    SizedBox(
                      ...
                      child: FlatButton(
                          ...
                          child: Text(
                            '分享立减7元',
                            style: TextStyle(
                                fontSize: setSp(15), color: Colors.white),
                          )),
                    ),
                    SizedBox(
                      width: setWidth(84),
                      ...
                      child: OutlineButton(
                          ...
                          onPressed: () {
                            ServiceApi()
                                .appointTender(context, widget.bidID)
                                .then((_) {
                          ...
                          child: Text(
                            '立即支付',
                            style: TextStyle(
                                fontSize: setSp(15), color: Color(0xFF1CCAD6)),
                          )),
                    ),
                  ],
                ),
              ...
              Padding(
                ...
                child: Text(
                  '预约服务费一经售出不支持退款',
                  style:
                      TextStyle(color: Color(0xff999999), fontSize: setSp(12)),
                ),
              )
            ],
          ),
