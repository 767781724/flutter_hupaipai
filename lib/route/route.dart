...
class Routes {
  ...
  static String root = "/";
  static String wechatLoginPage = "/wechatLoginPage";
  static String mobileLoginPage = "/mobileLoginPage";
  ...
  static void configureRoutes(Router router) {
    ...
    router.define(wechatLoginPage, handler: wechatLoginHandler);
    ...
    router.define(tenderSettingPage + "/:tenderModel",
        handler: tenderSettingHandler);
